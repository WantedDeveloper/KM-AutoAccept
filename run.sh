...
# === CONFIG ===
BOT_NAME="KM-AutoAccept"                      # service name
BOT_DIR="/root/KM-AutoAccept"                    # repo directory
BOT_MAIN="bot.py"                       # main bot file
PYTHON_BIN="/usr/bin/python3"            # check with: which python3
GIT_REPO="https://github.com/WantedDeveloper/KM-AutoAccept.git"
